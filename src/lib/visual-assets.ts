...
export const HERO_ORBIT_NODES = [
  {
    ...
    className: "left-[2%] top-[22%] w-[14%] sm:w-[11%] lg:w-[9%]",
    floatDuration: 6.2,
    parallax: 0.55,
    showOnMobile: true,
  },
  {
    ...
    className: "left-[8%] bottom-[18%] w-[18%] sm:w-[14%] lg:w-[12%] opacity-80",
    floatDuration: 7.4,
    parallax: 0.7,
    showOnMobile: false,
  },
  {
    ...
    className: "right-[6%] top-[16%] w-[15%] sm:w-[12%] lg:w-[10%] opacity-85",
    floatDuration: 7.1,
    parallax: -0.45,
    showOnMobile: true,
  },
  {
    ...
    className: "right-[1%] bottom-[20%] w-[17%] sm:w-[13%] lg:w-[11%] opacity-75",
    floatDuration: 6.8,
    parallax: -0.6,
    showOnMobile: false,
  },
  {
    ...
    className: "left-[18%] top-[12%] hidden w-[9%] opacity-50 lg:block",
    floatDuration: 9.2,
    parallax: 0.35,
    showOnMobile: false,
  },
